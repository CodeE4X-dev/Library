...
local aa = {
	...
	[63] = function()
		...
		return {
			...
			AcrylicBorder = Color3.fromRGB(83, 20, 20),
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(39, 0, 0), Color3.fromRGB(54, 0, 0)),
			AcrylicNoise = 0.92,
			TitleBarLine = Color3.fromRGB(126, 0, 0),
			Tab = Color3.fromRGB(180, 50, 50),
			Element = Color3.fromRGB(160, 40, 40),
			ElementBorder = Color3.fromRGB(59, 0, 0),
			InElementBorder = Color3.fromRGB(110, 30, 30),
			ElementTransparency = 0.87,
			ToggleSlider = Color3.fromRGB(160, 20, 20),
			ToggleToggled = Color3.fromRGB(0, 0, 0),
			SliderRail = Color3.fromRGB(160, 30, 30),
			DropdownFrame = Color3.fromRGB(200, 70, 70),
			DropdownHolder = Color3.fromRGB(80, 0, 0),
			DropdownBorder = Color3.fromRGB(65, 10, 10),
			DropdownOption = Color3.fromRGB(160, 20, 20),
			Keybind = Color3.fromRGB(160, 60, 60),
			Input = Color3.fromRGB(160, 20, 20),
			InputFocused = Color3.fromRGB(30, 0, 0),
			InputIndicator = Color3.fromRGB(190, 50, 50),
			Dialog = Color3.fromRGB(80, 0, 0),
			DialogHolder = Color3.fromRGB(65, 0, 0),
			DialogHolderLine = Color3.fromRGB(60, 0, 0),
			DialogButton = Color3.fromRGB(80, 10, 10),
			DialogButtonBorder = Color3.fromRGB(110, 20, 20),
			DialogBorder = Color3.fromRGB(100, 10, 10),
			DialogInput = Color3.fromRGB(85, 0, 0),
			DialogInputLine = Color3.fromRGB(190, 40, 40),
			Text = Color3.fromRGB(240, 240, 240),
