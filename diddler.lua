...
local Themes = {
    ...
    ["Ruby Ember"] = {
        ...
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 15, 15), Color3.fromRGB(50, 20, 20)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(240, 80, 80),
        Tab = Color3.fromRGB(220, 60, 60),

        Element = Color3.fromRGB(50, 20, 20),
        ElementBorder = Color3.fromRGB(80, 35, 35),
        InElementBorder = Color3.fromRGB(80, 35, 35),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(90, 35, 35),
        ToggleToggled = Color3.fromRGB(240, 90, 90),

        SliderRail = Color3.fromRGB(70, 30, 30),

        DropdownFrame = Color3.fromRGB(60, 25, 25),
        DropdownHolder = Color3.fromRGB(60, 25, 25),
        DropdownBorder = Color3.fromRGB(40, 15, 15),
        DropdownOption = Color3.fromRGB(50, 20, 20),

        Keybind = Color3.fromRGB(55, 25, 25),

        Input = Color3.fromRGB(45, 18, 18),
        InputFocused = Color3.fromRGB(70, 30, 30),
        InputIndicator = Color3.fromRGB(240, 80, 80),

        Dialog = Color3.fromRGB(50, 20, 20),
        DialogHolder = Color3.fromRGB(60, 25, 25),
        ...
        DialogInputLine = Color3.fromRGB(240, 80, 80),

        Text = Color3.fromRGB(255, 220, 220),
        SubText = Color3.fromRGB(230, 180, 180),
        Hover = Color3.fromRGB(240, 80, 80),
        HoverChange = 0.05
    },
    ["Emerald Glow"] = {
        Accent = Color3.fromRGB(40, 200, 110),

        AcrylicMain = Color3.fromRGB(15, 35, 25),
        AcrylicBorder = Color3.fromRGB(30, 70, 50),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 35, 25), Color3.fromRGB(20, 45, 30)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(60, 220, 130),
        Tab = Color3.fromRGB(40, 200, 110),

        Element = Color3.fromRGB(20, 45, 30),
        ElementBorder = Color3.fromRGB(35, 80, 55),
        InElementBorder = Color3.fromRGB(35, 80, 55),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(35, 100, 60),
        ToggleToggled = Color3.fromRGB(70, 230, 140),

        SliderRail = Color3.fromRGB(30, 70, 50),

        DropdownFrame = Color3.fromRGB(25, 55, 40),
        DropdownHolder = Color3.fromRGB(25, 55, 40),
        DropdownBorder = Color3.fromRGB(15, 35, 25),
        DropdownOption = Color3.fromRGB(20, 45, 30),

        Keybind = Color3.fromRGB(25, 60, 40),

        Input = Color3.fromRGB(18, 40, 28),
        InputFocused = Color3.fromRGB(30, 70, 50),
        InputIndicator = Color3.fromRGB(60, 220, 130),

        Dialog = Color3.fromRGB(20, 45, 30),
        DialogHolder = Color3.fromRGB(25, 55, 40),
        DialogHolderLine = Color3.fromRGB(15, 35, 25),
        DialogButton = Color3.fromRGB(30, 70, 50),
        DialogButtonBorder = Color3.fromRGB(40, 90, 65),
        DialogBorder = Color3.fromRGB(40, 200, 110),
        DialogInput = Color3.fromRGB(25, 60, 40),
        DialogInputLine = Color3.fromRGB(60, 220, 130),

        Text = Color3.fromRGB(220, 255, 235),
        SubText = Color3.fromRGB(180, 230, 200),
        Hover = Color3.fromRGB(60, 220, 130),
        HoverChange = 0.05
    },
    ["Sapphire Dream"] = {
        Accent = Color3.fromRGB(70, 120, 220),

        AcrylicMain = Color3.fromRGB(15, 25, 45),
        AcrylicBorder = Color3.fromRGB(30, 50, 90),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 25, 45), Color3.fromRGB(20, 35, 60)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(90, 140, 240),
        Tab = Color3.fromRGB(70, 120, 220),

        Element = Color3.fromRGB(20, 35, 60),
        ElementBorder = Color3.fromRGB(35, 60, 110),
        InElementBorder = Color3.fromRGB(35, 60, 110),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(40, 70, 130),
        ToggleToggled = Color3.fromRGB(100, 150, 250),

        SliderRail = Color3.fromRGB(30, 55, 100),

        DropdownFrame = Color3.fromRGB(25, 45, 80),
        DropdownHolder = Color3.fromRGB(25, 45, 80),
        DropdownBorder = Color3.fromRGB(15, 25, 45),
        DropdownOption = Color3.fromRGB(20, 35, 60),

        Keybind = Color3.fromRGB(25, 40, 75),

        Input = Color3.fromRGB(18, 30, 55),
        InputFocused = Color3.fromRGB(30, 55, 100),
        InputIndicator = Color3.fromRGB(90, 140, 240),

        Dialog = Color3.fromRGB(20, 35, 60),
        DialogHolder = Color3.fromRGB(25, 45, 80),
        DialogHolderLine = Color3.fromRGB(15, 25, 45),
        DialogButton = Color3.fromRGB(30, 55, 100),
        DialogButtonBorder = Color3.fromRGB(40, 70, 130),
        DialogBorder = Color3.fromRGB(70, 120, 220),
        DialogInput = Color3.fromRGB(25, 40, 75),
        DialogInputLine = Color3.fromRGB(90, 140, 240),

        Text = Color3.fromRGB(220, 235, 255),
        SubText = Color3.fromRGB(170, 190, 230),
        Hover = Color3.fromRGB(90, 140, 240),
        HoverChange = 0.05
    },
    ["Golden Dawn"] = {
        Accent = Color3.fromRGB(230, 180, 50),

        AcrylicMain = Color3.fromRGB(40, 35, 20),
        AcrylicBorder = Color3.fromRGB(70, 60, 35),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 35, 20), Color3.fromRGB(50, 45, 25)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(250, 200, 70),
        Tab = Color3.fromRGB(230, 180, 50),

        Element = Color3.fromRGB(50, 45, 25),
        ElementBorder = Color3.fromRGB(80, 70, 40),
        InElementBorder = Color3.fromRGB(80, 70, 40),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(90, 80, 45),
        ToggleToggled = Color3.fromRGB(250, 200, 70),

        SliderRail = Color3.fromRGB(70, 60, 35),

        DropdownFrame = Color3.fromRGB(60, 55, 30),
        DropdownHolder = Color3.fromRGB(60, 55, 30),
        DropdownBorder = Color3.fromRGB(40, 35, 20),
        DropdownOption = Color3.fromRGB(50, 45, 25),

        Keybind = Color3.fromRGB(55, 50, 30),

        Input = Color3.fromRGB(45, 40, 22),
        InputFocused = Color3.fromRGB(70, 60, 35),
        InputIndicator = Color3.fromRGB(250, 200, 70),

        Dialog = Color3.fromRGB(50, 45, 25),
        DialogHolder = Color3.fromRGB(60, 55, 30),
        DialogHolderLine = Color3.fromRGB(40, 35, 20),
        DialogButton = Color3.fromRGB(70, 60, 35),
        DialogButtonBorder = Color3.fromRGB(90, 80, 45),
        DialogBorder = Color3.fromRGB(230, 180, 50),
        DialogInput = Color3.fromRGB(55, 50, 30),
        DialogInputLine = Color3.fromRGB(250, 200, 70),

        Text = Color3.fromRGB(255, 240, 210),
        SubText = Color3.fromRGB(230, 210, 170),
        Hover = Color3.fromRGB(250, 200, 70),
        HoverChange = 0.05
    },
    ["Amethyst Mist"] = {
        Accent = Color3.fromRGB(170, 120, 210),

        AcrylicMain = Color3.fromRGB(35, 25, 45),
        AcrylicBorder = Color3.fromRGB(65, 50, 85),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 25, 45), Color3.fromRGB(45, 35, 60)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(190, 140, 230),
        Tab = Color3.fromRGB(170, 120, 210),

        Element = Color3.fromRGB(45, 35, 60),
        ElementBorder = Color3.fromRGB(75, 60, 95),
        InElementBorder = Color3.fromRGB(75, 60, 95),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(85, 70, 110),
        ToggleToggled = Color3.fromRGB(190, 140, 230),

        SliderRail = Color3.fromRGB(65, 50, 85),

        DropdownFrame = Color3.fromRGB(55, 45, 75),
        DropdownHolder = Color3.fromRGB(55, 45, 75),
        DropdownBorder = Color3.fromRGB(35, 25, 45),
        DropdownOption = Color3.fromRGB(45, 35, 60),

        Keybind = Color3.fromRGB(50, 40, 70),

        Input = Color3.fromRGB(40, 30, 55),
        InputFocused = Color3.fromRGB(65, 50, 85),
        InputIndicator = Color3.fromRGB(190, 140, 230),

        Dialog = Color3.fromRGB(45, 35, 60),
        DialogHolder = Color3.fromRGB(55, 45, 75),
        DialogHolderLine = Color3.fromRGB(35, 25, 45),
        DialogButton = Color3.fromRGB(65, 50, 85),
        DialogButtonBorder = Color3.fromRGB(85, 70, 110),
        DialogBorder = Color3.fromRGB(170, 120, 210),
        DialogInput = Color3.fromRGB(50, 40, 70),
        DialogInputLine = Color3.fromRGB(190, 140, 230),

        Text = Color3.fromRGB(240, 230, 255),
        SubText = Color3.fromRGB(210, 190, 230),
        Hover = Color3.fromRGB(190, 140, 230),
        HoverChange = 0.05
    },
    ["Crimson Tide"] = {
        ...
        AcrylicBorder = Color3.fromRGB(65, 30, 40),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 15, 20), Color3.fromRGB(45, 20, 25)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(200, 50, 80),
        Tab = Color3.fromRGB(180, 30, 60),

        Element = Color3.fromRGB(45, 20, 25),
        ElementBorder = Color3.fromRGB(75, 35, 45),
        InElementBorder = Color3.fromRGB(75, 35, 45),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(85, 40, 50),
        ToggleToggled = Color3.fromRGB(200, 50, 80),

        SliderRail = Color3.fromRGB(65, 30, 40),

        DropdownFrame = Color3.fromRGB(55, 25, 35),
        DropdownHolder = Color3.fromRGB(55, 25, 35),
        DropdownBorder = Color3.fromRGB(35, 15, 20),
        DropdownOption = Color3.fromRGB(45, 20, 25),

        Keybind = Color3.fromRGB(50, 25, 30),

        Input = Color3.fromRGB(40, 18, 23),
        InputFocused = Color3.fromRGB(65, 30, 40),
        InputIndicator = Color3.fromRGB(200, 50, 80),

        Dialog = Color3.fromRGB(45, 20, 25),
        DialogHolder = Color3.fromRGB(55, 25, 35),
        DialogHolderLine = Color3.fromRGB(35, 15, 20),
        DialogButton = Color3.fromRGB(65, 30, 40),
        DialogButtonBorder = Color3.fromRGB(85, 40, 50),
        DialogBorder = Color3.fromRGB(180, 30, 60),
        DialogInput = Color3.fromRGB(50, 25, 30),
        DialogInputLine = Color3.fromRGB(200, 50, 80),

        Text = Color3.fromRGB(255, 220, 225),
        SubText = Color3.fromRGB(230, 180, 190),
        Hover = Color3.fromRGB(200, 50, 80),
        HoverChange = 0.05
    },
    ["Neon Pulse"] = {
        ...
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 15, 20), Color3.fromRGB(20, 20, 25)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(0, 255, 200),
        Tab = Color3.fromRGB(0, 255, 170),

        Element = Color3.fromRGB(20, 20, 25),
        ElementBorder = Color3.fromRGB(35, 35, 45),
        InElementBorder = Color3.fromRGB(35, 35, 45),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(40, 40, 50),
        ToggleToggled = Color3.fromRGB(0, 255, 200),

        SliderRail = Color3.fromRGB(30, 30, 40),

        DropdownFrame = Color3.fromRGB(25, 25, 35),
        DropdownHolder = Color3.fromRGB(25, 25, 35),
        DropdownBorder = Color3.fromRGB(15, 15, 20),
        DropdownOption = Color3.fromRGB(20, 20, 25),

        Keybind = Color3.fromRGB(25, 25, 30),

        Input = Color3.fromRGB(18, 18, 23),
        InputFocused = Color3.fromRGB(30, 30, 40),
        ...
        DialogBorder = Color3.fromRGB(0, 255, 170),
    ...
    ["Cyber Mint"] = {
        ...
        AcrylicBorder = Color3.fromRGB(40, 70, 60),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 35, 30), Color3.fromRGB(25, 45, 40)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(0, 250, 170),
        Tab = Color3.fromRGB(0, 230, 150),

        Element = Color3.fromRGB(25, 45, 40),
        ElementBorder = Color3.fromRGB(45, 80, 70),
        InElementBorder = Color3.fromRGB(45, 80, 70),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(50, 90, 80),
        ToggleToggled = Color3.fromRGB(0, 250, 170),

        SliderRail = Color3.fromRGB(40, 70, 60),

        DropdownFrame = Color3.fromRGB(30, 55, 50),
        DropdownHolder = Color3.fromRGB(30, 55, 50),
        DropdownBorder = Color3.fromRGB(20, 35, 30),
        DropdownOption = Color3.fromRGB(25, 45, 40),

        Keybind = Color3.fromRGB(30, 50, 45),

        Input = Color3.fromRGB(22, 40, 35),
        InputFocused = Color3.fromRGB(40, 70, 60),
        InputIndicator = Color3.fromRGB(0, 250, 170),

        Dialog = Color3.fromRGB(25, 45, 40),
        DialogHolder = Color3.fromRGB(30, 55, 50),
        DialogHolderLine = Color3.fromRGB(20, 35, 30),
        DialogButton = Color3.fromRGB(40, 70, 60),
        DialogButtonBorder = Color3.fromRGB(50, 90, 80),
        DialogBorder = Color3.fromRGB(0, 230, 150),
        DialogInput = Color3.fromRGB(30, 50, 45),
        DialogInputLine = Color3.fromRGB(0, 250, 170),

        Text = Color3.fromRGB(220, 255, 240),
        SubText = Color3.fromRGB(170, 220, 200),
        Hover = Color3.fromRGB(0, 250, 170),
        HoverChange = 0.05
    },
    ["Desert Sand"] = {
        Accent = Color3.fromRGB(210, 170, 120),

        AcrylicMain = Color3.fromRGB(40, 35, 30),
        AcrylicBorder = Color3.fromRGB(70, 60, 50),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 35, 30), Color3.fromRGB(50, 45, 35)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(230, 190, 140),
        Tab = Color3.fromRGB(210, 170, 120),

        Element = Color3.fromRGB(50, 45, 35),
        ElementBorder = Color3.fromRGB(80, 70, 55),
        InElementBorder = Color3.fromRGB(80, 70, 55),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(90, 80, 65),
        ToggleToggled = Color3.fromRGB(230, 190, 140),

        SliderRail = Color3.fromRGB(70, 60, 50),

        DropdownFrame = Color3.fromRGB(60, 55, 45),
        DropdownHolder = Color3.fromRGB(60, 55, 45),
        DropdownBorder = Color3.fromRGB(40, 35, 30),
        DropdownOption = Color3.fromRGB(50, 45, 35),

        Keybind = Color3.fromRGB(55, 50, 40),

        Input = Color3.fromRGB(45, 40, 32),
        InputFocused = Color3.fromRGB(70, 60, 50),
        InputIndicator = Color3.fromRGB(230, 190, 140),

        Dialog = Color3.fromRGB(50, 45, 35),
        DialogHolder = Color3.fromRGB(60, 55, 45),
        DialogHolderLine = Color3.fromRGB(40, 35, 30),
        DialogButton = Color3.fromRGB(70, 60, 50),
        DialogButtonBorder = Color3.fromRGB(90, 80, 65),
        DialogBorder = Color3.fromRGB(210, 170, 120),
        DialogInput = Color3.fromRGB(55, 50, 40),
        DialogInputLine = Color3.fromRGB(230, 190, 140),

        Text = Color3.fromRGB(255, 240, 220),
        SubText = Color3.fromRGB(230, 210, 180),
        Hover = Color3.fromRGB(230, 190, 140),
        HoverChange = 0.05
    },
    ["Lavender Fields"] = {
        Accent = Color3.fromRGB(180, 160, 240),

        AcrylicMain = Color3.fromRGB(35, 30, 45),
        AcrylicBorder = Color3.fromRGB(65, 55, 85),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 30, 45), Color3.fromRGB(45, 40, 60)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(200, 180, 255),
        Tab = Color3.fromRGB(180, 160, 240),

        Element = Color3.fromRGB(45, 40, 60),
        ElementBorder = Color3.fromRGB(75, 65, 100),
        InElementBorder = Color3.fromRGB(75, 65, 100),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(85, 75, 115),
        ToggleToggled = Color3.fromRGB(200, 180, 255),

        SliderRail = Color3.fromRGB(65, 55, 85),

        DropdownFrame = Color3.fromRGB(55, 50, 75),
        DropdownHolder = Color3.fromRGB(55, 50, 75),
        DropdownBorder = Color3.fromRGB(35, 30, 45),
        DropdownOption = Color3.fromRGB(45, 40, 60),

        Keybind = Color3.fromRGB(50, 45, 70),

        Input = Color3.fromRGB(40, 35, 55),
        InputFocused = Color3.fromRGB(65, 55, 85),
        InputIndicator = Color3.fromRGB(200, 180, 255),

        Dialog = Color3.fromRGB(45, 40, 60),
        DialogHolder = Color3.fromRGB(55, 50, 75),
        DialogHolderLine = Color3.fromRGB(35, 30, 45),
        DialogButton = Color3.fromRGB(65, 55, 85),
        DialogButtonBorder = Color3.fromRGB(85, 75, 115),
        DialogBorder = Color3.fromRGB(180, 160, 240),
        DialogInput = Color3.fromRGB(50, 45, 70),
        DialogInputLine = Color3.fromRGB(200, 180, 255),

        Text = Color3.fromRGB(240, 235, 255),
        SubText = Color3.fromRGB(210, 200, 235),
    ...
    ["Obsidian Edge"] = {
        ...
        ToggleToggled = Color3.fromRGB(140, 140, 140),
    ...
    ["Coral Reef"] = {
        ...
        AcrylicMain = Color3.fromRGB(35, 25, 20),
        AcrylicBorder = Color3.fromRGB(65, 45, 35),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 25, 20), Color3.fromRGB(45, 30, 25)),
        AcrylicNoise = 0.9,

        TitleBarLine = Color3.fromRGB(255, 150, 120),
        Tab = Color3.fromRGB(255, 130, 100),

        Element = Color3.fromRGB(45, 30, 25),
        ElementBorder = Color3.fromRGB(75, 50, 40),
        InElementBorder = Color3.fromRGB(75, 50, 40),
        ElementTransparency = 0,

        ToggleSlider = Color3.fromRGB(85, 60, 45),
        ToggleToggled = Color3.fromRGB(255, 150, 120),

        SliderRail = Color3.fromRGB(65, 45, 35),

        DropdownFrame = Color3.fromRGB(55, 40, 30),
        DropdownHolder = Color3.fromRGB(55, 40, 30),
        DropdownBorder = Color3.fromRGB(35, 25, 20),
        DropdownOption = Color3.fromRGB(45, 30, 25),

        Keybind = Color3.fromRGB(50, 35, 30),

        Input = Color3.fromRGB(40, 28, 22),
        InputFocused = Color3.fromRGB(65, 45, 35),
        InputIndicator = Color3.fromRGB(255, 150, 120),

        Dialog = Color3.fromRGB(45, 30, 25),
        DialogHolder = Color3.fromRGB(55, 40, 30),
        DialogHolderLine = Color3.fromRGB(35, 25, 20),
        DialogButton = Color3.fromRGB(65, 45, 35),
        DialogButtonBorder = Color3.fromRGB(85, 60, 45),
        DialogBorder = Color3.fromRGB(255, 130, 100),
        DialogInput = Color3.fromRGB(50, 35, 30),
        DialogInputLine = Color3.fromRGB(255, 150, 120),

        Text = Color3.fromRGB(255, 230, 220),
        SubText = Color3.fromRGB(230, 190, 175),
        Hover = Color3.fromRGB(255, 150, 120),
        HoverChange = 0.05
    }
}
...
function Creator.GetThemeProperty(Property)
	...
	return Themes["Lunar Dusk"][Property]
end
...
function Library:CreateWindow(Config)
	...
	Library.Theme = Config.Theme or "Lunar Dusk"
    ...
    New("UIPadding", {
        PaddingBottom = UDim.new(0, 0), -- Buang padding supaya tidak mempengaruhi saiz
        PaddingLeft = UDim.new(0, 0),
        PaddingRight = UDim.new(0, 0),
        PaddingTop = UDim.new(0, 0),
    }),
    New("ImageLabel", {
        Image = "rbxthumb://type=Asset&id=122634158253809&w=150&h=150",
        Size = UDim2.new(1, 0, 1, 0),
